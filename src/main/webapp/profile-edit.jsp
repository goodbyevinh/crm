                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" readonly value="${task.getJob().getName()}" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Tên công việc</label>
                                    <div class="col-md-12">
                                        <input type="text" readonly value="${task.getName()}" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" readonly value="${task.getEndDate()}" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Trạng thái</label>
                                    <div class="col-md-12">
                                        <select statusName="${task.getStatus().getName()}" id="select-status" class="form-control form-control-line">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a taskId="${task.getId()}" class="btn btn-success btn-update-profile">Lưu lại</a>
