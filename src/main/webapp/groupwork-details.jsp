                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 id="yet-rate-bar" class="counter text-right m-t-15 text-danger">${jobDetail.getYetRate()}%</h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" id="yet-bar">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 id="doing-rate-bar" class="counter text-right m-t-15 text-megna">${jobDetail.getDoingRate()}%</h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-megna" role="progressbar"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" id="doing-bar">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 id="completed-rate-bar" class="counter text-right m-t-15 text-primary">${jobDetail.getCompletedRate()}%</h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary" role="progressbar"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" id="completed-bar">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="white-box">
                                ...
                                <div class="message-center">
                                    <c:forEach items="${user.getTasks()}" var="task">
                                        <c:set var = "id" value = "${task.getStatus().getId()}"/>
                                        <c:if test = "${id == 1}">
                                            <a href="#">
