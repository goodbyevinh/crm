            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=request.getContextPath() + Url.ADD_TASK%>" class="btn btn-sm btn-success btn-add">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                    ...
                                    <tbody>
                                        <c:forEach items="${tasks}" var="task">
                                            <tr>
                                                ...
                                                <td>
                                                    <a taskId="${task.getId()}" href="<%=request.getContextPath() + Url.UPDATE_TASK%>" class="btn btn-sm btn-primary btn-update">Sửa</a>
                                                    <a taskId="${task.getId()}" href="#" class="btn btn-sm btn-danger btn-delete">Xóa</a>
<%--                                                    <a taskId="${task.getId()}" href="#" class="btn btn-sm btn-info btn-view">Xem</a>--%>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
