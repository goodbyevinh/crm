            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=request.getContextPath() + Url.ADD_JOB%>" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${jobs}" var="job">
                                            <tr>
                                                ...
                                                <td>
                                                    <a jobId="${job.getId()}" href="<%=request.getContextPath() + Url.UPDATE_JOB%>" class="btn btn-sm btn-primary btn-update">Sửa</a>
                                                    <a jobId="${job.getId()}" href="#" class="btn btn-sm btn-danger btn-delete">Xóa</a>
                                                    <a jobId="${job.getId()}" href="<%=request.getContextPath() + Url.JOB_DETAIL%>" class="btn btn-sm btn-info btn-view">Xem</a>
                                                </td>
                                            </tr>
