            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form id="add-role-form" class="form-horizontal form-material" action="http://localhost:8081/crm/add-role" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="description" type="text" placeholder="Mô tả" class="form-control form-control-line" name="description"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a class="btn btn-success btn-add-role">Add Role</a>
                                        <a href="<%=request.getContextPath() + Url.ROLE%>" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
