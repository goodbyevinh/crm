                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        ...
                                        <h4 class="text-white">${userDetail.getFullname()}</h4>
                                        <h5 class="text-white">${userDetail.getEmail()}</h5>
                                    </div>
                                </div>
                            </div>
	...
	<div class="row">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="white-box">
				<div class="col-in row">
					<div class="col-xs-12">
						<h3 id="yet-rate-bar" class="counter text-right m-t-15 text-danger">${userDetail.getYetRate()}%</h3>
                    </div>
                    <div class="col-xs-12">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="white-box">
				<div class="col-in row">
					<div class="col-xs-12">
						<h3 id="doing-rate-bar" class="counter text-right m-t-15 text-megna">${userDetail.getDoingRate()}%</h3>
                    </div>
                    <div class="col-xs-12">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="white-box">
				<div class="col-in row">
					<div class="col-xs-12">
						<h3 id="completed-rate-bar" class="counter text-right m-t-15 text-primary">${userDetail.getCompletedRate()}%</h3>
                    </div>
                    <div class="col-xs-12">
						<i class="linea-icon linea-basic" data-icon="&#xe00b;"></i>
