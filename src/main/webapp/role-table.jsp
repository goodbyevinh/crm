            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=request.getContextPath() + Url.ADD_ROLE%>" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                    ...
                                    <tbody id="role-body">
                                        <c:forEach items="${roles}" var="role">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<%=request.getContextPath() + Url.UPDATE_ROLE%>" roleId="${role.getId()}" class="btn btn-sm btn-primary btn-update">Sửa</a>
