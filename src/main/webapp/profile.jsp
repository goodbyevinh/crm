                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="white-box">
                                    <div class="col-in row">
                                        <div class="col-xs-12">
                                            <h3 class="counter text-right m-t-15 text-danger">${userDetail.getYetRate()}%</h3>
                                        </div>
                                        <div class="col-xs-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="white-box">
                                    <div class="col-in row">
                                        <div class="col-xs-12">
                                            <h3 class="counter text-right m-t-15 text-megna">${userDetail.getDoingRate()}%</h3>
                                        </div>
                                        <div class="col-xs-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="white-box">
                                    <div class="col-in row">
                                        <div class="col-xs-12">
                                            <h3 class="counter text-right m-t-15 text-primary">${userDetail.getCompletedRate()}%</h3>
                                        </div>
                                        <div class="col-xs-12">
                                            <i class="linea-icon linea-basic" data-icon="&#xe00b;"></i>
                                    ...
                                    <tbody>
                                        <c:forEach items="${tasks}" var="task">
                                            <tr>
                                                <td>${task.getId()}</td>
                                                <td>${task.getName()}</td>
                                                <td>${task.getJob().getName()}</td>
                                                <td>${task.getStartDate()}</td>
                                                <td>${task.getEndDate()}</td>
                                                <td>${task.getStatus().getName()}</td>
                                                <td>
                                                    <a taskId="${task.getId()}" href="<%=request.getContextPath() + Url.PROFILE_EDIT%>" class="btn btn-sm btn-primary btn-edit">Cập nhật</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
