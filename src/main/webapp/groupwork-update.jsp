...
<body>
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a jobId="${job.getId()}" class="btn btn-success btn-update-job">Lưu lại</a>
                                        <a href="<%=request.getContextPath() + Url.JOB%>" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script src="js/update-job.js"></script>
</body>
