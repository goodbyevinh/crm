...
@WebServlet(name = "jobApi", urlPatterns = {
        Url.API_JOB_ALL
})
public class JobApi extends HttpServlet {
    BaseService baseService = JobService.getINSTANCE();
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (pathInfo) {
            ...
            case Url.API_UPDATE: {
                Gson gson = new Gson();
                JobModel job =  gson.fromJson(req.getReader(), JobModel.class);
                boolean isSuccess = baseService.updateModel(job);
            ...
            case Url.API_ADD : {
                Gson gson = new Gson();
                JobModel job =  gson.fromJson(req.getReader(), JobModel.class);
                boolean isSuccess = baseService.insertModel(job);
